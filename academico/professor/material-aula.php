                            ...
                            <div class="card">
                                <div class="panel">
                                    <div class="panel-body txt-block">
                                        ...
                                        <h2 class="">Material de Aula</h2>
                                        <h4 class="sub-header">Enviar material para a turma:
                                            <select name="tEst" id="cEst">
                                <optgroup label="Engenharia de Computação">
                                    <option value="ED"> Estrutura de dados</option>
                                    <option value="GR" selected> Grafos</option>
                                </optgroup>
                                <optgroup label="Engenharia de Telecomunicações">
                                    <option value="ED"> Estrutura de dados</option>
                                    <option value="SS"> Sinais e sistemas</option>
                                </optgroup>
                                <optgroup label="Engenharia Mecânica">
                                    ...
                                    <option value="MM"> Mecânica de materiais</option>
                                            ...
                                            <input class="but" type="image" name="tEnviar" src="imgs/butpost.png" />
                                        </h4>
                                        <p><button type="button">Selecionar Material</button></p>
                                        ...
                                        <table style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>07/09/2017</th>
                                                    <th><b>Nenhum material postado nesta disciplina ainda </b></th>
                                                </tr>
                                                <tr>
