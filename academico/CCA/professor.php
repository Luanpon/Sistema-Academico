        ...
        <div class="logo">
          ...
          <div><img src="imgs/iconcca.png" class="len"></div>
            ...
            <ul class="nav">
                ...
                <li class="active"><a href="professor.php"><p>Cadastrar Professor</p></a></li>
                  ...
                  <div class="card">
                    <div class="panel">
                      <div class="panel-body txt-block">
                        ...
                        <!-- Formulário -->
                        <form action="processaprofessor.php" method="POST" name="form1">
                            ...
                            <h4>Matrícula</h4>
                            <div class="margin-contato">
                                <input type="text" name="nivel" class="form-control" placeholder="Titulação" required />
                            </div>
                            <div class="margin-contato">
                                <input type="text" name="dpto" class="form-control" placeholder="Departamento" required />
                            </div>

                            <button class="btn btn-block " type="submit" name="criar"><i class="fa fa-sign-in"></i> Enviar dados do Professor</button>
                        </form>
                      </div>
                    </div>
                  </div>
